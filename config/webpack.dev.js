...
module.exports = [
  ...
  webpackMerge(commonConfig({
    ...
    entry: {
      'import-export': 'entrypoints/import-export',
    },
    ...
    module: {
      rules: [{
        ...
        test: /\.css$/,
        include: path.resolve(contextDir, 'js', 'entrypoints', 'import-export', 'styles'),
      ...
      {
        test: /\.css$/,
        exclude: path.resolve(contextDir, 'js', 'entrypoints', 'import-export', 'styles'),
        loader: 'raw-loader',
      }],
    },
